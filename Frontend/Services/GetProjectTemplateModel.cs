    ...
    public class GetProjectTemplateModel : IGetProjectTemplateModel
    {
        ...
        private List<ProjectTemplateAcademyModel> GetAcademyData(List<Academy> academies)
        {
            ...
            foreach (var academy in academies)
            {
                ...
                academyModel.NumberOnRoll = $"{academy.GeneralInformation.NumberOnRoll} ({academy.GeneralInformation.PercentageFull})";
                academyModel.PercentageFreeSchoolMeals = academy.GeneralInformation.PercentageFsm;
                academyModel.OfstedLastInspection = DatesHelper.DateStringToGovUkDate(academy.LatestOfstedJudgement.InspectionDate);
                ...
                academyModel.DistanceFromTheAcademyToTheTrustHeadquarters = academy.GeneralInformation.DistanceToSponsorHq;
                ...
                academyModel.PupilsFsm6Years = academy.PupilNumbers.PercentageEligibleForFreeSchoolMealsDuringLast6Years;
                ...
                academyModel.KeyStage4Performance = PerformanceDataHelpers.GetFormattedKeyStage4Results(academy.EducationPerformance.KeyStage4Performance);
                academyModel.KeyStage5Performance = academy.EducationPerformance.KeyStage5Performance;
                academyModel.KeyStage2AdditionalInformation = academy.EducationPerformance.KeyStage2AdditionalInformation;
                academyModel.KeyStage4AdditionalInformation = academy.EducationPerformance.KeyStage4AdditionalInformation;
                academyModel.KeyStage5AdditionalInformation = academy.EducationPerformance.KeyStage5AdditionalInformation;
