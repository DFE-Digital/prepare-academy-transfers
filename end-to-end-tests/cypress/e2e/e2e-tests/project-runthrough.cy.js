...
describe.skip("Creating and editing an academy transfer", { tags: '@dev'}, function () {
    beforeEach(function () {        
        cy.login();
    ...
    it.skip("Edit an Academy Transfer", function () {
        ...
        cy.clickBackLink()
        cy.clickDataTest("target-date")
        cy.fillInDateMonthYear(Cypress.dayjs().add(3, 'M'))
        submit()
        ...
        // *** School performance ***
        // Key stage 2 performance tables - tests located at project-runthrough-ks2.js
